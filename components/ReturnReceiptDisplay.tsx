  ...
  (
    ...
    return (
      <div 
        ...
        ref={ref} 
        className={`bg-white p-6 border border-slate-200 text-sm font-mono text-slate-800 leading-tight max-h-full overflow-y-auto ${paperSize === '80mm' ? 'receipt-80mm' : 'receipt-58mm'}`}
        style={{ minHeight: '400px' }} // Ensure visibility for image/pdf generation
      >
        <div className="text-center mb-4">
          <h2 className="text-lg font-bold mb-1">AK Alheri Chemist PPMVS Kurfi</h2>
          <p className="text-xs text-slate-500">No.2&3 Maraɗi Aliyu Street Opposite JIBWIS Jumma'a Masjid Kurfi</p>
          <p className="text-xs text-slate-500">Tel: 09060605362, 07039177740</p>
          <p className="text-xs text-slate-500">Email: kabirbalakurfi@gmail.com</p>
        </div>
        ...
        <div className="mb-2">
          <p className="font-medium text-slate-700 mb-1">Original Sale Details:</p>
          <div className="border-b border-dashed border-slate-300 pb-2 mb-2 space-y-1 text-xs">
            <div className="flex justify-between">
              <span>Sale ID:</span>
            ...
            <div className="flex justify-between">
              ...
              <span>{originalSale.invoiceNumber || 'N/A'}</span>
            </div>
            <div className="flex justify-between">
              <span>Date:</span>
        ...
        <div className="mb-2">
          <p className="font-medium text-slate-700 mb-1">Returned Items:</p>
